...
export function getTemplatesData(): SecretTemplate[] {
	const templates = [
		...
		},
		{
			...
			provider: 'together',
			icon: '🤝',
			description: 'Together AI API key for open-source models',
		...
		},
		{
			...
			icon: '🤝',
			description:
				'Use your Together AI API key for open-source models via Cloudflare AI Gateway',
			instructions: 'Go to Together AI → Settings → API Keys → Create new key',
			placeholder: 'Your Together AI API key',
			validation: '^.{10,}$',
			required: false,
		...
		},
		{
			...
			icon: '⚡',
			description:
				'Use your Groq API key for ultra-fast LLM inference via Cloudflare AI Gateway',
